...
public class DealershipFileManager {
    public static Dealership getDealership() {
        try {
            ...
            String input = bufferedReader.readLine(); // Read First line of file
            String[] dealershipDetails = input.split("\\|"); // Splits on each pipe
            String name = dealershipDetails[0];
            String address = dealershipDetails[1];
            String phone = dealershipDetails[2];

            //Below reads vehicles in the inventory
